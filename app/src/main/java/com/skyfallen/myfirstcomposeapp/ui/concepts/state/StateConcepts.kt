package com.skyfallen.myfirstcomposeapp.ui.concepts.state
...
fun MyState(modifier: Modifier = Modifier) {
    ...
    Column(modifier = modifier) {
        Text(text = "Púlsame: ${number.intValue}", Modifier.clickable { number.intValue += 1 })
        Text(text = "Púlsame: ", Modifier.clickable { number.intValue += 1 })
        Text(text = "Púlsame:", Modifier.clickable { number.intValue += 1 })
        Text(text = "Púlsame: ${number.intValue}", Modifier.clickable { number.intValue += 1 })
        Text(text = "Púlsame:", Modifier.clickable { number.intValue += 1 })
    }
